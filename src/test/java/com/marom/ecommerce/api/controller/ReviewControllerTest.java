...
class ReviewControllerTest {
    ...
    void should_returnBadRequest_when_ratingIsMissing() throws Exception {
        // Arrange
        ReviewRequest request = ReviewRequest.builder().customerId(3L).comment("Great product.").build();
    ...
    void should_returnBadRequest_when_ratingIsOutOfRange() throws Exception {
        // Arrange
        ReviewRequest request = ReviewRequest.builder().customerId(3L).rating(6).comment("Great product.").build();
    ...
    void should_returnBadRequest_when_commentIsBlank() throws Exception {
        // Arrange
        ReviewRequest request = ReviewRequest.builder().customerId(3L).rating(5).comment("").build();
    ...
    void should_returnConflict_when_customerAlreadyReviewedProduct() throws Exception {
        // Arrange
        ReviewRequest request = ReviewRequest.builder().customerId(3L).rating(5).comment("Great product.").build();
        when(reviewService.createReview(eq(1L), any(ReviewRequest.class)))
    ...
    void should_returnNotFound_when_productDoesNotExistOnCreate() throws Exception {
        // Arrange
        ReviewRequest request = ReviewRequest.builder().customerId(3L).rating(5).comment("Great product.").build();
        when(reviewService.createReview(eq(404L), any(ReviewRequest.class)))
